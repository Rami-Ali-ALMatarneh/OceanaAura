        ...
        public static void Seed(ModelBuilder builder)
        {
            ...
            builder.Entity<LookUpEntity>().HasData(
               ...
               new LookUpEntity
               {
                ...
                new LookUpEntity
                {
                    LookUpId = (int)LookUpEnums.ProductSizeCategory.ML355,
                    NameEn = "355ml",
                    NameAr = "355 مل",
                    LookupCategoryId = (int)LookUpEnums.CategoryCode.ProductSize,
                    CreatedBy = "admin",
                    IsDeleted = false,
                    CreatedOn = DateTime.Now,
                    ModifyBy = null,
                ...
                new LookUpEntity
                {
                    LookUpId = (int)LookUpEnums.ProductSizeCategory.ML650,
                    NameEn = "650ml",
                    NameAr = "650 مل",
                    LookupCategoryId = (int)LookUpEnums.CategoryCode.ProductSize,
                    CreatedBy = "admin",
                ...
                new LookUpEntity
                {
                    LookUpId = (int)LookUpEnums.ProductSizeCategory.ML740,
                    NameEn = "740ml",
                    NameAr = "740 مل",
                    LookupCategoryId = (int)LookUpEnums.CategoryCode.ProductSize,
                    CreatedBy = "admin",
                ...
                new LookUpEntity
                {
                    LookUpId = (int)LookUpEnums.ProductSizeCategory.Liter1,
                    NameEn = "1 Liter",
                    NameAr = "1 لتر",
                    LookupCategoryId = (int)LookUpEnums.CategoryCode.ProductSize,
                    CreatedBy = "admin",
                ...
                new LookUpEntity
                {
                    LookUpId = (int)LookUpEnums.ProductSizeCategory.Liter1_2,
                    NameEn = "1.2 Liter",
                    NameAr = "1.2 لتر",
                    LookupCategoryId = (int)LookUpEnums.CategoryCode.ProductSize,
                    CreatedBy = "admin",
                ...
                new LookUpEntity
                {
                    LookUpId = (int)LookUpEnums.ProductAdditionalCategory.MagneticLid,
                    NameEn = "Magnetic Lid",
